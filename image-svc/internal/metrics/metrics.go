// Package metrics owns the Prometheus registry and every kiln_* metric
...
// Metrics holds the registry and the kiln_* collectors. One instance is
...
func New() *Metrics {
	m := &Metrics{
		...
		eventsProcessed: prometheus.NewCounterVec(prometheus.CounterOpts{
			Name: "kiln_events_processed_total",
...
func typeLabel(eventType string) string {
	if eventType == processor.EventTypeProcessingRequested {
		return eventType
	}
	return "other"
}
