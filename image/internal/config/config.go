// Package config parses the image service's environment: Postgres/Redis URLs,
...
// Config is the resolved image service runtime configuration.
type Config struct {
...
const (
	...
	defaultConcurrency   = 2 // parity with the BullMQ worker the image service replaced
